...
_USER_NEWS_TMPL = (
    ...
    "  Не больше половины пунктов про США.\n"
    "  РАЗНЫЕ ТЕМЫ В ПУНКТАХ: если в корзине 2 пункта — это 2 РАЗНЫЕ темы "
    "  (например нефть + решение ЦБ, или санкции + инфляция). НЕ два пункта "
    "  про нефть с разных сторон ('цена упала' + 'страна X сменила "
    "  поставщика') — это один сюжет, оставь сильнейший и найди вторую тему.\n"
