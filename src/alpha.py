...
_SYSTEM = (
    ...
    "   тренды взяты из одной статьи-подборки (explodingtopics, "
    "   trendhunter и подобные агрегаторы) — это пересказ чужого обзора, "
    ...
    "   медицинских изделий — ОБЯЗАТЕЛЬНО добавь одну строку в 'Как "
    "   запустить': какие документы нужны для легальной продажи в России:\n"
